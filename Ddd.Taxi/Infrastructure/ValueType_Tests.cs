...
namespace Ddd.Infrastructure
{
	...
	public class ValueType_Tests
	{
		...
		[Test]
		public void SupermenNotEqual()
		{
			var s1 = new SuperMan(100);
			var other = new SuperMan(20);
			Assert.IsFalse(s1.Equals(other));
		}

		[Test]
		public void SameSupermenAreEqual()
		{
			var s1 = new SuperMan(100);
			var other = new SuperMan(100);
			Assert.IsTrue(s1.Equals(other));
		}
	...
	public class SuperMan : Person
	{
		...
		public SuperMan(int speed) : 
			base(new PersonName("super", "man"), 200, new DateTime())
		{
			Speed = speed;
		}
	}
